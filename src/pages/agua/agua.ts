...
export class AguaPage {
  ...
  ionViewDidLoad() {
    ...
    this.hora_1 = dispositivo.agua.hora_1;
    this.hora_2 = dispositivo.agua.hora_2;
    this.hora_3 = dispositivo.agua.hora_3;
    this.hora_4 = dispositivo.agua.hora_4;
    this.hora_5 = dispositivo.agua.hora_5;
    this.hora_6 = dispositivo.agua.hora_6;
  ...
  guardar(){
    ...
    this.bluetoothSerial.write("PA" + codigo  + "\n");
  }
